...
public:
    ...
    {
        route_map_.replace(protocol, sub_invoker_function{ [func](auto&& ...params) {
    ...
    {
        route_map_.replace(protocol, sub_invoker_function{ [func, self](auto&& ...params) {
    ...
    {
        route_raw_map_.replace(protocol, sub_invoker_function_raw{ [func](auto&& ...params) {
            invoker_raw<Function>::apply(func, std::forward<decltype(params)>(params)...);
        }});
    }
    ...
    {
        route_raw_map_.replace(protocol, sub_invoker_function_raw{ [func, self](auto&& ...params) {
            invoker_raw<Function>::template apply_member<Self>(func, self, std::forward<decltype(params)>(params)...);
        }});
    }
